...
// Sticky navigation: interrsection observe API
...
[...h1.parentElement.children].forEach(el => {
  if (el !== h1) el.style.transform = 'rotate(30deg)';
});
*/
